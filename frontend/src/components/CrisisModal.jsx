                ...
                >
                    <div className="p-6">
                        ...
                        <div className="space-y-3">
                            <a href="tel:14416" className="flex items-center justify-between p-4 bg-red-50 hover:bg-red-100 rounded-xl transition-colors group">
                                <div className="flex items-center gap-3">
                                    <Phone className="text-red-500 group-hover:scale-110 transition-transform" size={20} />
                                    <div>
                                        <div className="font-bold text-red-900">14416 Tele-MANAS (India)</div>
                                        <div className="text-xs text-red-600">24/7 Mental Health Support</div>
                                    </div>
                                </div>
